...
local redzlib = {
	Themes = {
		Darker = { -- Este será o seu tema principal RED BLACK
			["Color Hub 1"] = ColorSequence.new({
				ColorSequenceKeypoint.new(0.00, Color3.fromRGB(0, 0, 0)),   -- Fundo Preto
				ColorSequenceKeypoint.new(0.50, Color3.fromRGB(5, 5, 5)),    -- Centro quase preto
				ColorSequenceKeypoint.new(1.00, Color3.fromRGB(0, 0, 0))    -- Fundo Preto
			}),
			["Color Hub 2"] = Color3.fromRGB(0, 0, 0),        -- Fundo Secundário Preto
			["Color Stroke"] = Color3.fromRGB(255, 0, 0),     -- BORDAS VERMELHAS
			["Color Theme"] = Color3.fromRGB(200, 0, 0),      -- DETALHES/LINHAS EM VERMELHO
			["Color Text"] = Color3.fromRGB(255, 255, 255),   -- Texto Branco para contraste
			["Color Dark Text"] = Color3.fromRGB(150, 0, 0)   -- Texto secundário Vermelho Escuro
		},
		Dark = { -- Um tom de vermelho mais suave
			["Color Hub 1"] = ColorSequence.new({
				ColorSequenceKeypoint.new(0.00, Color3.fromRGB(10, 0, 0)),
				ColorSequenceKeypoint.new(0.50, Color3.fromRGB(20, 0, 0)),
